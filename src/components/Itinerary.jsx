...
function Itinerary({itinerario}) {
  ...
  return (
        <div className=' flex flex-col flex-wrap my-5 bg-gray-950 text-gray-200 items-center w-3/4 rounded-xl'>
          ...
          <p className='text-lg p-5 md:text-xl xl:text-2xl lg:w-[80ch] font-serif'>{itinerario.description}</p>
          <p className='text-center font-semibold text-xl pt-5'>Price: {precio(itinerario.price)}</p>
          ...
          <section>
            ...
            <div className='flex flex-col items-center'>
              {itinerario.activities.map((e) => <img key={Math.random()} className='w-full my-2 lg:w-[1024px] rounded-xl' src={e}></img>)}
            </div>
          </section>
